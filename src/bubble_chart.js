...
function bubbleChart() {
  ...
  // Increases brightness of hex colour by a given percentage
  ...
  function showTooltip2(d) {
    ...
    tooltip.showTooltip("Topic " + d3.select(this)[0][0]["id"], d3.event);
  }

  function hideTooltip2(d) {
    d3.select(this).attr("fill", temp_col)
    tooltip.hideTooltip();
  }
  /*
